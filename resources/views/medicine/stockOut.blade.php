                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('medicine.edited', $medInfo->id) }}">
                          ...
                          <!--  {{-- Name --}}
                            ...
                            <div class="row mb-3">
                                <label for="stockOut"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Stock Out') }}</label>
                                <div class="col-md-6">
                                    <input id="stockOut" type="number"
                                        class="form-control @error('stockOut') is-invalid @enderror" name="stockOut"
                                        value="" required autocomplete="stockOut" autofocus>
